<x-head title="Ajouter Admin"></x-head>
    ...
    @if (Session::has('user_type') == 'admin')
        ...
        <div class="flex justify-center items-center min-h-screen">
            <div class="bg-white p-8 rounded shadow-md w-full max-w-md">
                <h2 class="text-2xl font-bold mb-6 text-center" style="color: #a39475;">Add Admin</h2>
                ...
                <form action="{{ route('admins.store') }}" method="POST">
                    ...
                    <div class="flex items-center justify-between">
                        <button type="submit"
                            class="w-full bg-customGold text-white py-2 px-4 rounded hover:bg-customBronze focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-customGold">Add
                            Admin</button>
                    </div>
                </form>
            </div>
