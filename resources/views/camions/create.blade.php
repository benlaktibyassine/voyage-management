<x-head title="Ajouter Camion"></x-head>
...
<body class="bg-gray-100">
    @if (Session::has('user_type') == 'admin')
        ...
        <div class="container mx-auto p-6 bg-white shadow-md rounded-lg mt-6">
            <h1 class="text-3xl font-bold mb-6 text-gray-800">Ajouter un Camion</h1>

            <form action="{{ route('camions.store') }}" method="POST" class="space-y-4">
                @csrf
