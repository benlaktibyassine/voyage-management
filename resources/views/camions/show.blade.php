<x-head title="Détails du Camion"></x-head>
    ...
    @if (Session::has('user_type') == 'admin')
        ...
        <div class="container mx-auto p-6">
            <div class="bg-white shadow-md rounded-lg p-6">
                <h1 class="text-3xl font-bold mb-6 text-gray-800">{{ $camion->matricule }}</h1>
                <p class="text-gray-600"><strong>Marque:</strong> {{ $camion->marque }}</p>
                <p class="text-gray-600"><strong>Modèle:</strong> {{ $camion->modele }}</p>
                <div class="mt-4">
