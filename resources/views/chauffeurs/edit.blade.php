<x-head title="Modifier Chauffeur"></x-head>
...
<body class="bg-gray-100">
    @if (Session::has('user_type') == 'admin')
        ...
        <div class="container mx-auto p-6 bg-white shadow-md rounded-lg mt-6">
            <h1 class="text-3xl font-bold mb-6 text-gray-800">Modifier le Chauffeur</h1>
            ...
            <form action="{{ route('chauffeurs.update', $chauffeur->id) }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="nom" id="nom" value="{{ old('nom', $chauffeur->nom) }}"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="prenom" id="prenom" value="{{ old('prenom', $chauffeur->prenom) }}"
                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                    @error('prenom')
                        <span class="text-red-500 text-sm">{{ $message }}</span>
                    @enderror
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="telephone" id="telephone"
                        value="{{ old('telephone', $chauffeur->telephone) }}"
                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                    @error('telephone')
                        <span class="text-red-500 text-sm">{{ $message }}</span>
                    @enderror
                ...
                <div>
                    <button type="submit"
                        class="px-4 py-2 bg-blue-600 text-white font-medium rounded-md hover:bg-blue-700">Modifier
                        Chauffeur</button>
                </div>
            </form>
        </div>
