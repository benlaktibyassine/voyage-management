<x-head title="Détails du Chauffeur"></x-head>
    ...
    @if (Session::has('user_type') == 'admin')
        ...
        <div class="container mx-auto p-6">
            <div class="bg-white shadow-md rounded-lg p-6">
                <h1 class="text-3xl font-bold mb-6 text-gray-800">{{ $chauffeur->nom }} {{ $chauffeur->prenom }}</h1>
                <div class="w-48 h-48 mb-4 overflow-hidden">
                    <img src="data:image/jpeg;base64,{{ base64_encode($chauffeur->image) }}" alt="{{ $chauffeur->nom }}"
                        class="w-full h-full object-cover object-center">
                </div>
                <p class="text-gray-600"><strong>Téléphone:</strong> {{ $chauffeur->telephone }}</p>
                <div class="mt-4">
